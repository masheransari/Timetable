...
public class Thursday extends Fragment {
    ...
    private void iniCard() {
        ...
        card.addChild2("CG","1.30-2.30");
        card.addChild2("MATHS","2.30-3.30");


        card1.addChild1("AOA","A1 (402)");
        card1.addChild2("CG","A2 (501)");
        card1.addChild2("DBMS","A4 (607)");
        ...
        CardViewNative cardView1 = (CardViewNative)getActivity().findViewById(R.id.pracs4);
