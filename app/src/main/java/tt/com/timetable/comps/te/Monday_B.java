...
public class Monday_B extends Fragment {
    ...
    private void iniCard() {
        ...
        card1.addChild1("NW"," B1 (603)");
        card1.addChild2("PM"," B4 (402)");

        card2.changeHeader("");
        card2.Subtitle("11.00 to 1.00");
        card2.addChild1("NW", "B1 (603)");
        card2.addChild2("MC","B2 (607)");
        card2.addChild2("SPCC", "B3 (402)");
        card2.addChild2("SE", "B4 (503)");
