...
public class Friday_B extends Fragment {
    ...
    private void iniCard() {
        ...
        card.addChild1("SPCC","10.00-11.00");
        card.addChild2("SE","11.00- 12.00");
        card.addChild2("MC","12.00-1.00");
        card.addChild2("PDDBMS","3.30-4.30");

        card1.changeHeader("Practicals");
        card1.Subtitle("1.30 to 3.30");
        card1.addChild1("PM"," B1 (603)");
        card1.addChild2("SPCC"," B2 (402)");
        card1.addChild2("SE"," B3 (503)");
        card1.addChild2("DDBMS"," B4 (508)");

        CardViewNative cardView = (CardViewNative)getActivity().findViewById(R.id.te_LectureCard5);
        cardView.setCard(card);
        CardViewNative cardView2 = (CardViewNative)getActivity().findViewById(R.id.Pracs5a);
