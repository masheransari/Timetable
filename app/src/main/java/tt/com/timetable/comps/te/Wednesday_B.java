...
public class Wednesday_B extends Fragment {
    ...
    private void iniCard() {
        ...
        card.addChild2("PM","3.30-4.30");
        card.addChild2("DDBMS","4.30-5.30");

        card1.changeHeader("Practicals");
        card1.Subtitle("9.00 to 11.00");
        card1.addChild1("NW"," B3 (603))");
        card1.addChild2("DDBMS"," B2 (508)");

        card2.changeHeader("");
        card2.Subtitle("11.00 to 1.00");
        card2.addChild1("SPCC","B1 (402)");
        card2.addChild2("SE","B2 (503)");
        card2.addChild2("NW","B3 (603)");
        card2.addChild2("MC","B4 (607)");
